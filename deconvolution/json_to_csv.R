...
jsonlist_to_row <- function(x) {
  ...
  data.frame(
    ...
    match_Z = x$cox$logistic_match$coef,
    match_se = x$cox$logistic_match$se,
    match_p = x$cox$logistic_match$p,
    ipw_Z = x$cox$logistic_ipw$coef,
    ipw_se = x$cox$logistic_ipw$se,
    ipw_p = x$cox$logistic_ipw$p,
